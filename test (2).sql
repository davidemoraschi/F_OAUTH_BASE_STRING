DECLARE
   ...
   BEGIN
      ...
      oauth_base_string :=
            pkg_oauth.base_string (http_method
                                               ,oauth_api_url
                                               ,oauth_consumer_key
                                               ,oauth_timestamp
                                               ,oauth_nonce
      ...
      var_http_authorization_header :=
            pkg_oauth.authorization_header_no_token (oauth_consumer_key, oauth_timestamp, oauth_nonce, oauth_signature);

   v_http_req_url :=
               utl_linkedin.http_req_url (oauth_api_url, oauth_consumer_key, oauth_timestamp, oauth_nonce, oauth_signature);
